...
import gov.cdc.android.news.activity.FilePickerActivity;
import gov.cdc.android.news.data.dao.DaoUtils;
import gov.cdc.android.news.data.dao.FeedDao;
import gov.cdc.android.news.fragment.feed.details.FeedDetailsFragment;
import gov.cdc.android.news.fragment.feed.details.IFeedDetailsCaller;
import gov.cdc.android.news.model.Feed;
import gov.cdc.android.news.utils.dialog.ConfirmDialog;
import gov.cdc.android.news.utils.dialog.IConfirmCallback;
import gov.cdc.android.news.utils.dialog.ToastUtils;
import gov.cdc.android.news.utils.feed.io.ExportFeedResult;
import gov.cdc.android.news.utils.feed.io.ExportFeedTask;
import gov.cdc.android.news.utils.feed.io.IExportFeedListener;
import gov.cdc.android.news.utils.feed.io.IImportFeedListener;
import gov.cdc.android.news.utils.feed.io.ImportFeedResult;
import gov.cdc.android.news.utils.feed.io.ImportFeedTask;
import gov.cdc.android.news.utils.feed.io.ImportFeedResult.State;
import gov.cdc.android.news.utils.feed.load.ConnectFeedTask;
import gov.cdc.android.news.utils.feed.load.FeedSearcher;
...
public class FeedListFragment extends ListFragment implements IFeedDetailsCaller, ISaveFeedListener, IImportFeedListener, IExportFeedListener
{
    ...
    {
        if ( result.getState() == gov.cdc.android.news.utils.feed.io.ExportFeedResult.State.SUCCESS )
        {
